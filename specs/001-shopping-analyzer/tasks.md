...
- [X] T049 [US1] Create ReceiptProcessingController with upload endpoint in backend/src/AgenticShopper.Coordinator/Controllers/ReceiptsController.cs
- [X] T050 [US1] Implement receipt image upload to Azure Blob Storage (integrated in ReceiptAgent)
- [X] T051 [US1] Implement ReceiptParser to map OCR results to Receipt entity (integrated in ReceiptAgent)
- [X] T052 [US1] Create Coordinator receipt processing workflow (integrated via ReceiptsController)
...
- [X] T068 [US2] Create CategorizationController with suggest/assign endpoints in backend/src/AgenticShopper.Agents.Categorization/Controllers/CategorizationController.cs
- [X] T069 [US2] Implement category preference storage (FR-009) in ProductRepository
- [X] T070 [P] [US2] Implement FrequencyAgent in backend/src/AgenticShopper.Agents.Frequency/FrequencyAgent.cs
...
- [X] T097 [US3] Add "recently purchased outside system" marking functionality (FR-021)
- [X] T098 [US3] Update CoordinatorAgent with shopping list generation workflow
...
- [X] T129 [US4] Add promotion expiry date indicators in UI
